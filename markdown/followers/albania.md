...
The `number of followers` of users in Albania on `2024/7/16 11:16 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/martingjeci">
				<img src="https://avatars.githubusercontent.com/u/108077887?s=72&v=4" width="24" alt="Avatar of martingjeci"> martingjeci
			</a><br/>
			Martin Gjeci
		</td>
		<td>No Company</td>
