...
The `number of followers` of users in Armenia on `2024/7/3 12:49 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.
